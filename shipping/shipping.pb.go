...
type CreateShippingResponse struct {
	...
	DeliveryForecastDays int32                  `protobuf:"varint,2,opt,name=delivery_forecast_days,json=deliveryForecastDays,proto3" json:"delivery_forecast_days,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *CreateShippingResponse) GetDeliveryForecastDays() int32 {
	if x != nil {
		return x.DeliveryForecastDays
	}
	return 0
}
...
const file_shipping_proto_rawDesc = "" +
	...
	"shippingId\x124\n" +
	"\x16delivery_forecast_days\x18\x02 \x01(\x05R\x14deliveryForecastDays2G\n" +
	"\bShipping\x12;\n" +
	"\x06Create\x12\x16.CreateShippingRequest\x1a\x17.CreateShippingResponse\"\x00B<Z:github.com/pimentaluan/microservices-proto/golang/shippingb\x06proto3"
...
var file_shipping_proto_depIdxs = []int32{
	...
	0, // 1: Shipping.Create:input_type -> CreateShippingRequest
